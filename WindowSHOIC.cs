...
namespace SHOIC
{
public partial class WindowSHOIC : Form
{
...
private void WindowSHOICLoad(object sender, EventArgs e)
{
...
{
try{
TextBoxTarget.Text = Dns.GetHostEntry(new Uri(url).Host).AddressList.Single().ToString();
}catch
{
...
TextBoxTarget.Text = txtTargetIP.Text;
...
{
string starget=TextBoxTarget.Text;//ComboTargetURL.SelectedValue.ToString();
